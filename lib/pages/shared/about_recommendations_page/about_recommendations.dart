...
class AboutRecommendations extends StatefulWidget {
  const AboutRecommendations({Key? key}) : super(key: key);

  @override
  _AboutRecommendationsState createState() => _AboutRecommendationsState();
}

class _AboutRecommendationsState extends State<AboutRecommendations> {
  @override
